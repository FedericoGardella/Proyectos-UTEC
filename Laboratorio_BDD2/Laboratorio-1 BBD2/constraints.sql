...
ADD CONSTRAINT fk_visitantes_articulos FOREIGN KEY (id_articulos) REFERENCES articulos(id_articulos),
...
ADD CONSTRAINT fk_mov_art_sti_articulos FOREIGN KEY (id_articulos) REFERENCES articulos(id_articulos),
ADD CONSTRAINT fk_mov_art_sti_usuarios FOREIGN KEY (nom_usuario) REFERENCES usuarios(nom_usuario),
ADD CONSTRAINT fk_mov_art_sti_visitantes FOREIGN KEY (id_visit) REFERENCES visitantes(id_visit);
